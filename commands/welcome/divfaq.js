...
class DivFaqCommand extends commando.Command
{
    ...
    async run(message, args)
    {
        ...
        .setDescription("__**My friend is interested in joining the Discord, how can I get an invite for them?**__",
        "Please feel free to contact any <@&630489074360123392> for further details.", true)
        .setDescription("__**I'm unsure if my comment/language will offend someone?**__",
        "Please feel free to run this by any <@&630489074360123392>. Alternatively you can also research this on the internet.", true)
        .setDescription("__**I have a suggestion for the server, where can I post this?**__",
