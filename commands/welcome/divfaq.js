...
class DivFaqCommand extends commando.Command
{
    ...
    async run(message, args)
    {
        ...
        .setTitle("__FAQ__")
        .setDescription("\n\n"+
        "__**When will I become a verified member?**__\n\n"+
        ...
        "__**I'm unsure if my comment/language will offend someone?**__\n\n"+
        "Please feel free to run this by any <@&630489074360123392>. Alternatively you can also research this on the internet.\n\n"+
        "__**I have a suggestion for the server, where can I post this?**__\n\n"+
