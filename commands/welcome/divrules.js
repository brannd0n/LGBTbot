...
class DivRulesCommand extends commando.Command
{
    ...
    async run(message, args)
    {
        ...
        "\n **1)** Diversity RS is a platform to bring the community together. We ask all members to research the subject before joining a discussion to avoid conflict and miscommunication. It is okay to ask questions but please be mindful of how you approach certain topics. \n \n" +
        ...
        "**4)** - Please be respectful of everyone's opinions, regardless of their race, ethnicity, sexuality or gender. \n \n" +
        "- Do not assume each others identities, as your assumptions may not always be correct.\n \n"+
        "- Please respect each other’s pronouns and try your best to use them correctly. \n \n" +
        "**5)** Some sensitive topics are allowed to be discussed in this server, however please avoid topics of self harm or suicide.\n\n" +
        "**6)** __**We cannot help with banned accounts in this server,**__ so please don’t request any of the Jmods investigate a banned account, visit the official [help pages](https://support.runescape.com/hc/en-gb/articles/115002238729) for further information. \n \n", true)
        .addField("\u200b",
