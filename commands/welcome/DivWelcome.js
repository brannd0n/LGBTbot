...
class DivWelcomeCommand extends commando.Command
{
    ...
    async run(message, args)
    {
        ...
        .setColor(0xFF0000)
        .addBlankField()
        .addField("Diversity is a large spectrum and encompasses age, race and ethnicity, religion/belief, disability (both physical and mental), neurodivergence, class, gender, sexuality and more.", true)
        .addField("So if you feel you identify within any of these elements within the diversity spectrum of any other minority or underrepresented group, please also provide your perspective.", true)
        .addField("Inclusion is about understanding diversity and making changes to make sure everyone feels comfortable and represented.", true)
