...
class AdminResponsibilitiesCommand extends commando.Command
{
    ...
    async run(message, args)
    {
        ...
        .addField("\u200b","If you find yourself in a situation where you are unsure about what you should do, look for a @Head Admin for assistance, they are here to directly assist you, they are experienced that they know how to deal with any issue that comes forward, only under extreme circumstances do leadership need to get involved. (that doesn’t mean you should be afraid to ask leadership for help if no headadmins are online)\n\n" +
