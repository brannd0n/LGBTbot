...
class DivChamp2Command extends commando.Command
{
    ...
    async run(message, args)
    {
        ...
        "Please keep an eye on <#630747807577538570> for new members, once they have filled out all the information you will see a ticket at the top of the server, read through the information and when you are happy you can assign them the <@&630765616697049088> or <@&630765530030014476> roles (remember to check the forums to see that they have posted). \n\n" +
        ...
        "PLEASE REMEMBER TO READ WHAT EACH INDIVIDUAL HAS BEEN SAYING BEFORE VERIFYING.", true)
        .addField("\200b", "Due to the amount of trolls we received when we first opened the server this is a way for us to get to know our members better without locking the server completely, after 25+ messages we should know a person's interests well enough to determine if they are here to troll or not.")
