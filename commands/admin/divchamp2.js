...
class DivChamp2Command extends commando.Command
{
    ...
    async run(message, args)
    {
        ...
        .addField("\200b", "Due to the amount of trolls we received when we first opened the server this is a way for us to get to know our members better without locking the server completely, after 25+ messages we should know a person's interests well enough to determine if they are here to troll or not.", true)
