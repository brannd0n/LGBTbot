...
class DivChamp2Command extends commando.Command
{
    ...
    async run(message, args)
    {
        ...
        "Please keep an eye on <#630747807577538570> for new members, once they have filled out all the information you will see a ticket at the top of the server, read through the information and when you are happy they aren’t a troll you can assign them the <@&630765616697049088> or <@&630765530030014476> which will unlock the rest of the server. React with :x: on the ticket and the room will be deleted and the introduction in <#630747807577538570> will be removed (Remember to check the official RS forum thread to see that they have posted there before assigning any roles)" )
