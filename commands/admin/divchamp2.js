...
class DivChamp2Command extends commando.Command
{
    ...
    async run(message, args)
    {
        ...
        "Please keep an eye on <#630747807577538570> for new members, once they have filled out all the information and you are happy they aren’t a troll you can assign them the <@&630765616697049088> or <@&630765530030014476> role which will unlock the rest of the server. (Remember to check the official RS forum thread to see that they have posted there)\n\n")
