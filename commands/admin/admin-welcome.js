...
class AdminWelcomeCommand extends commando.Command
{
    ...
    async run(message, args)
    {
        ...
        .setColor(0x991919)
        .addField("📋 __**THE LGBT+ ADMIN HANDBOOK**__ 📋", "Welcome to the Admin team! We are glad to have you on board with us, our core job is to ensure all clan members have the best experience possible while here, and that we provide a safe and friendly environment for the LGBT+ community within Runescape.\n\n" +
