...
class AdminRecruitmentCommand extends commando.Command
{
    ...
    async run(message, args)
    {
        ...
        "Quick find code: `290-291-452-66119156`\n" +
        "[Click here to visit the forum thread.](http://services.runescape.com/m=forum/c=WfmoI4xdajU/forums.ws?290,291,452,66119156,goto,1)\n\n" +
        ...
        "If a player has posted an application form on our forum thread, you should respond with a kind greeting if they are accepted. Request that they guest in the clan chat until a member of the admin team is available to meet up in-game and offer them an invite. If you are not online at the time of accepting their applications, please post in <#618186687775899654> to alert everyone, making sure they are aware of the person needing an invite.")
