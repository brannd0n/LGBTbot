...
class AdminApplicationCommand extends commando.Command
{
    ...
    async run(message, args)
    {
        ...
        .addField("\u200b","11. With the community management team we have a large focus around elements of the clan chat, discord and the official forums. What ideas or suggestions would you like to bring in to make improvements from your perspective? \n\n" +
