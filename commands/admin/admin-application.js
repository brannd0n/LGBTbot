...
class AdminApplicationCommand extends commando.Command
{
    ...
    async run(message, args)
    {
        ...
        "9. As part of this role you will need to be competent with the Google applications (Docs, Sheets & Forms), what experience\n do you have with these tools? Do you have expertise with any of these\n e.g. vlookups, conditional formatting, pivot tables?\n\n" +
        "10. You will need to be an ambassador for the clan and on-boarding new recruits to the clan, effectively the welcoming face of the clan. Is there any parts you’re not 100% on within\n the LGBT+ community and would like support from the admin team if you were successful? E.g. Pronouns, intersexuality etc.\n\n")
        .addField("\u200b","11. With the community management team we have a large focus around elements of the clan chat, discord and the official forums. What ideas or suggestions\n would you like to bring in to make improvements from your perspective? \n\n" +
        "12. We have our friendly LGBoT+ in the discord which helps us with making posts in the discord, do you have any\n experience with coding? If not would you be willing to learn? \n\n" +
