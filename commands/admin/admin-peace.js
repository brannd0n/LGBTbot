...
class AdminPeaceCommand extends commando.Command
{
    ...
    async run(message, args)
    {
        ...
        .setColor(0x991919)
        .addField("�0�4 __**KEEPING THE PEACE**__ �0�4", "We pride ourself on being a friendly community, that is open to members and guests alike. Our guests are treated the same as a fully pledged member, and as a result, will be required to abide by the same rules.\n\n" +
        ...
        .addField(��\u200b��, "�6�7Allowing guests leaves us vulnerable to mass spam/troll attacks, so please remember to remain vigilant and alert, and be prepared to kick & ban as fast as possible should we ever fall victim.\n\n" +
        "�6�1 Announce in cc you will be setting a pin and any guests should send you a PM or check discord for the current pin.\n\n" +
        "�6�1 Inform everyone in Admin that you are applying a pin due to a troll attack.\n\n" +
        "�6�1@everyone in #clan-announcements that the pin is active and clearly state what the current pin is.\n\n" +
        "�6�1Provide evidence in #admin showing why the pin was activated.\n\n" +
