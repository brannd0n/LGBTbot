...
class BarrowsSixCommand extends commando.Command
{
    constructor(client)
    {
        super(client,{
      ...
      async run(message, args)
      {
        ...
        .addField("\u200b", "[Strategies for Barrows Rise of The Six](https://runescape.wiki/w/Barrows:_Rise_of_the_Six/Strategies)")
...
module.exports = BarrowsSixCommand;
