...
class FistofguthixCommand extends commando.Command
{
    constructor(client)
    {
        super(client,{
            ...
            examples: ['./fistofguthix "28 September" "20:00" "Describe where to meet and a basic premise here"'],
            args: [
                {
                    key: 'date',
    ...
    async run(message, args)
    {
        ...
        .setThumbnail("https://vignette.wikia.nocookie.net/runescape2/images/1/17/Fist_of_Guthix_icon.jpg/revision/latest?cb=20080728141256")
